...
> Ko je ležajni ščit pravilno vpet, nadzorna lučka odraža stanje ustrezne ali neustrezne transmisivnosti vzorca - ZELENA lučka pomeni, da je kos optično dovolj prepusten in ustrezen za proces varjenja na motor. RDEČA lučka predstavlja optično neustrezen kos, ki ga ni možno ustrezno zavariti na motor, torej gre na izmet. MODRA lučka predstavlja vmesno stanje, tj. za motorje, katerih optična prepustnost je vprašljiva. Slednje je potrebno zbirati ločeno, in preveriti transmisivnost še z alternativnimi merilnimi metodami - kontaktiraj oddelek Razvoj Tehnologij.
